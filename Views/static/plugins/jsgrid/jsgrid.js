...
(function(jsGrid, $, undefined) {
    ...
    DirectLoadingStrategy.prototype = {
        ...
        lastDisplayIndex: function() {
            var grid = this._grid;
            var itemsCount = grid.option("ch06.6.3.data").length;
        ...
        itemsCount: function() {
            return this._grid.option("ch06.6.3.data").length;
        },
        ...
        finishLoad: function(loadedData) {
            this._grid.option("ch06.6.3.data", loadedData);
        },

        finishInsert: function(insertedItem) {
            var grid = this._grid;
            grid.option("ch06.6.3.data").push(insertedItem);
            grid.refresh();
        },

        finishDelete: function(deletedItem, deletedItemIndex) {
            var grid = this._grid;
            grid.option("ch06.6.3.data").splice(deletedItemIndex, 1);
            grid.reset();
        }
    };
    ...
    PageLoadingStrategy.prototype = {
        ...
        finishLoad: function(loadedData) {
            ...
            this._grid.option("ch06.6.3.data", loadedData.data);
        },
